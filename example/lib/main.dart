...
class _LoginScreenState extends State<LoginScreen> {
  ...
  String get _username => language.code == 'VN' ? 'tên tài khoản' : 'Username';

  String get _login => language.code == 'VN' ? 'đăng nhập' : 'Login';

  String get _signup => language.code == 'VN' ? 'đăng ký' : 'Sign Up';
